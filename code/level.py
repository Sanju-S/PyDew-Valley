...
class Level:
	...
	def player_add(self, item: str, amount: int = 1) -> None:
	...
	def reset(self) -> None:
		...
		# refill seed
		self.player.seed_inventory = SEED_REFILL
		...
		if self.soil_layer.plant_sprites:
			for plant in self.soil_layer.plant_sprites.sprites():
				if plant.harvastable and plant.rect.colliderect(self.player.hitbox):
					...
					self.soil_layer.grid[plant.rect.centery // TILE_SIZE][plant.rect.centerx // TILE_SIZE].remove(self.soil_layer.PLANT)
